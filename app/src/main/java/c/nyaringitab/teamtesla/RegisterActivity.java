...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCreatedBtn = (Button) findViewById(R.id.reg_create_btn);

        mCreatedBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                //if statement checks if text utils are empty to pass registration
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    userMap.put("status", "Hi there, I'm using Greenapp");
